...
export default function WhatsAppButton() {
  ...
  const link = `https://wa.me/${whatsapp}?text=${encodeURIComponent("Hi Zupwell! I have a question about your products.")}`;
  ...
  return (
    <div className="fixed bottom-6 right-5 z-40 flex flex-col items-end gap-2">
      ...
      <motion.a
        ...
        className="h-11 w-11 rounded-full bg-[#25D366] flex items-center justify-center relative"
        style={{
      ...
      >
        ...
        {/* Pulse animation */}
        <span className="absolute h-11 w-11 rounded-full bg-[#25D366] animate-ping opacity-20" />
      </motion.a>
    </div>
  );
}
