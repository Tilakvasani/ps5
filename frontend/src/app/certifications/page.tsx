      ...
      <div>
        ...
        <div className="pt-32 pb-20 px-6 mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-black mb-4 leading-tight" style={{ color: "#0C1E39", letterSpacing: "-0.04em" }}>
              Our <span style={{ color: "var(--or)" }}>Certifications</span>
            </h1>
            <p className="text-sm max-w-xl mx-auto leading-relaxed" style={{ color: "#4A5568", fontWeight: 500 }}>
