      ...
      <div>
        ...
        <div className="pt-32 pb-20 px-6 mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-black mb-4 leading-tight" style={{ color: "#FFFFFF", letterSpacing: "-0.04em" }}>
              Our <span style={{ color: "var(--or)" }}>Certifications</span>
            </h1>
            <p className="text-sm max-w-xl mx-auto leading-relaxed" style={{ color: "#F8F8F8", fontWeight: 500 }}>
          ...
          <div className="space-y-6">
            {certs.map((c, i) => (
              ...
              >
                <div className="shrink-0 flex items-center justify-center p-3 rounded-2xl bg-white/5 border border-[#0C1E39]" style={{ minWidth: 80, height: 80 }}>
                ...
                <div>
                  ...
                  <p className="font-semibold text-sm mb-2" style={{ color: "#F8F8F8" }}>{c.title}</p>
                  <p className="text-sm leading-relaxed" style={{ color: "#F8F8F8" }}>{c.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="mt-16 p-8 rounded-3xl text-center border border-dashed border-[#FF5C00]/30" style={{ background: "rgba(255,92,0,0.03)" }}>
            ...
            <p className="text-sm max-w-2xl mx-auto leading-relaxed" style={{ color: "#F8F8F8" }}>
