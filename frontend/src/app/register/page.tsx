  ...
  return (
    <main className="relative min-h-screen bg-[#F4F6FA] flex items-center justify-center px-6 py-12">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-40 right-1/4 h-[500px] w-[500px] rounded-full bg-[#F47C41]/8 blur-[120px]" />
        ...
        <div className="card p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button type="submit" disabled={loading} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
              ...
              {loading ? <span className="flex items-center justify-center gap-2"><span className="h-4 w-4 rounded-full border-2 border-[#D9DEE8] border-t-transparent animate-spin" />Creating account...</span> : "Create Free Account"}
            </motion.button>
          </form>

          <p className="text-center text-xs text-[#6B7280] mt-4">
            By creating an account you agree to our <Link href="#" className="text-[#F47C41]">Terms</Link> and <Link href="#" className="text-[#F47C41]">Privacy Policy</Link>
          </p>
          ...
          <p className="text-center text-sm text-[#6B7280]">
            ...
            <Link href="/login" className="font-semibold text-[#F47C41] hover:text-[#f79b6e]">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </main>
