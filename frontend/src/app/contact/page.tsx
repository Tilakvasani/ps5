  ...
  return (
    <main className="min-h-screen bg-[#F1FAFF] overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-16 px-6 bg-white overflow-hidden">
        <div className="pointer-events-none absolute -top-40 -left-40 h-[400px] w-[400px] rounded-full bg-[#45B08C]/6 " />
        <div className="relative mx-auto max-w-3xl text-center">
          <motion.span {...fadeUp(0)} className="inline-block text-xs font-semibold uppercase tracking-widest text-[#45B08C] mb-4">
            Contact Us
          </motion.span>
          <motion.h1 {...fadeUp(0.1)} className="text-5xl md:text-6xl font-black text-[#1D3557] mb-4 leading-tight">
            Got Questions?<br />
            <span className="gradient-text">We've Got Answers!</span>
          </motion.h1>
          <motion.p {...fadeUp(0.2)} className="text-lg text-[#4A6A82]">
        ...
        <div className="mx-auto max-w-4xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {whatsappLink && (
            <motion.a {...fadeUp(0)} href={whatsappLink} target="_blank" rel="noopener noreferrer"
              className="card flex flex-col items-center text-center gap-3 hover:border-green-400/40 hover:bg-[#EBF7F3]/50 transition-all group cursor-pointer">
              <div className="h-12 w-12 rounded-2xl bg-[#EBF7F3] flex items-center justify-center group-hover:bg-green-100 transition-all">
                <MessageCircle size={22} className="text-[#45B08C]" />
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-[#4A6A82] mb-1">WhatsApp</p>
                <p className="font-bold text-[#1D3557] text-sm">+{s(settings, "contact_whatsapp")}</p>
                <p className="text-xs text-[#45B08C] mt-1 font-semibold">Chat now →</p>
              </div>
            </motion.a>
          )}
          ...
          <motion.a {...fadeUp(0.05)} href={`mailto:${s(settings, "contact_support_email")}`}
            className="card flex flex-col items-center text-center gap-3 hover:border-[#45B08C]/30 transition-all group cursor-pointer">
            <div className="h-12 w-12 rounded-2xl bg-[#45B08C]/10 flex items-center justify-center group-hover:bg-[#45B08C]/20 transition-all">
              <Mail size={22} className="text-[#45B08C]" />
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#4A6A82] mb-1">Support Email</p>
              <p className="font-bold text-[#1D3557] text-sm break-all">{s(settings, "contact_support_email")}</p>
            </div>
          </motion.a>
          ...
          <motion.a {...fadeUp(0.1)} href={`mailto:${s(settings, "contact_info_email")}`}
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#4A6A82] mb-1">Info Email</p>
              <p className="font-bold text-[#1D3557] text-sm break-all">{s(settings, "contact_info_email")}</p>
            </div>
          </motion.a>
          ...
          <motion.div {...fadeUp(0.15)} className="card flex flex-col items-center text-center gap-3">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#4A6A82] mb-2">Follow Us</p>
              <div className="flex items-center justify-center gap-3">
                {s(settings, "contact_instagram") && (
                  <a href={s(settings, "contact_instagram")} target="_blank" rel="noopener noreferrer"
                    className="h-8 w-8 rounded-lg bg-[#F1FAFF] flex items-center justify-center hover:opacity-80 transition-opacity">
                ...
                {!s(settings, "contact_instagram") && !s(settings, "contact_facebook") && (
                  <p className="text-xs text-[#7A9BB5]">Coming soon</p>
                )}
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="mx-auto max-w-3xl">
          ...
          <motion.form {...fadeUp(0.1)} onSubmit={handleSubmit} className="card space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                <label className="label-text flex items-center gap-1.5">
                  <User size={13} className="text-[#45B08C]" /> Full Name *
                </label>
              ...
              <div>
                <label className="label-text flex items-center gap-1.5">
                  <Building size={13} className="text-[#45B08C]" /> Firm Name
                </label>
              ...
              <div>
                <label className="label-text flex items-center gap-1.5">
                  <MapPin size={13} className="text-[#45B08C]" /> City *
                </label>
              ...
              <div>
                <label className="label-text flex items-center gap-1.5">
                  <MapPin size={13} className="text-[#45B08C]" /> State
                </label>
            ...
            <div>
              <label className="label-text flex items-center gap-1.5">
                <Briefcase size={13} className="text-[#45B08C]" /> Experience in Distribution
              </label>
            ...
            <div>
              <label className="label-text flex items-center gap-1.5">
                <FileText size={13} className="text-[#45B08C]" /> Message *
              </label>
            ...
            <p className="text-xs text-center text-[#7A9BB5]">
