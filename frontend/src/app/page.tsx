  ...
  return (
    <main className="relative min-h-screen bg-[#F4F6FA] overflow-x-hidden">
      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-[#6B7280]">Everything you need for modern packaging operations</p>
          </motion.div>
      ...
      <section className="py-24 px-6 relative">
        ...
        <div className="mx-auto max-w-7xl relative">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-[#6B7280]">Trusted by 1000+ businesses across Gujarat and India</p>
          </motion.div>
      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-display font-black text-[#111827] mb-3">What Clients <span className="gradient-text">Say</span></h2>
            <p className="text-[#6B7280]">Real feedback from real businesses</p>
          </motion.div>
