    ...
    <main className="relative min-h-screen bg-[#FCFAF6] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 px-6">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-40 -right-40 h-[600px] w-[600px] rounded-full bg-[#002A30]/15 blur-3xl" />
        </div>
        ...
        <div className="mx-auto max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10 relative">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <motion.h1 {...fadeUp(0.08)} className="text-5xl md:text-7xl lg:text-[76px] font-black leading-[0.98] tracking-tight mb-6 text-[#002A30] font-sans">
            ...
            <motion.div {...fadeUp(0.3)} className="mt-16 grid grid-cols-3 gap-8 w-full max-w-lg">
              {stats.map(([val, label]) => (
                <div key={label} className="text-left">
                  <div className="text-2xl font-black text-[#002A30]">{val}</div>
          ...
          <div className="lg:col-span-5 w-full flex justify-center items-center">
            <motion.div
              ...
              className="bg-gradient-to-br from-[#002A30] via-[#0d2226] to-[#1a1226] rounded-[2.5rem] shadow-2xl w-full max-w-md aspect-[4/4.2] flex items-center justify-center p-8 relative overflow-hidden"
            >
              {/* Backglows */}
              <div className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-[#EB9220]/20 blur-2xl" />
              <div className="absolute -bottom-20 -left-20 h-40 w-40 rounded-full bg-[#EB9220]/20 blur-2xl" />
              
              {/* Floating product card */}
              <motion.div
                whileHover={{ y: -6, rotate: 1 }}
                transition={{ duration: 0.3 }}
                className="bg-white rounded-[2rem] shadow-2xl w-64 p-8 text-center flex flex-col items-center border border-[#E8E2D9] relative z-10"
              >
                <span className="bg-[#002A30] text-white text-[9px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full mb-6">
                  HEALTH SUPPLEMENT
                </span>
                
                <div className="flex items-center justify-center gap-3 mb-6">
                  <span className="text-4xl">🍊</span>
                  <span className="text-3xl text-[#EB9220]">⚡</span>
                </div>
                
                <h3 className="text-2xl font-black text-[#002A30] leading-none tracking-tight font-sans">
                  zupwell
                </h3>
                <p className="text-[10px] font-extrabold text-[#002A30] uppercase tracking-[0.25em] mt-1">
                  ELECTROLYTE
                </p>
                
                <p className="text-[9px] font-semibold text-[#8C8276] uppercase tracking-wider mt-4">
                  ORANGE FLAVOUR · 15 TABLETS
                </p>
                
                <div className="mt-8 w-full">
                  <Link href="/products/zupwell-electrolyte-effervescent-tablet-orange-flavour-15-tablets">
                    <span className="inline-block bg-[#EB9220] text-white text-xs font-black tracking-widest px-8 py-3 rounded-full shadow-lg shadow-[#EB9220]/25 hover:scale-105 active:scale-95 transition-all">
                      ₹299.00
                    </span>
                  </Link>
                </div>
              ...
              <div className="rounded-3xl overflow-hidden shadow-xl border border-[#F5EFE6]" style={{ background: "#fff" }}>
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="relative md:w-56 shrink-0 flex flex-col" style={{ background: "#FCFAF6" }}>
                    ...
                    <div className="absolute left-0 top-0 bottom-0 w-1 rounded-l-3xl" style={{ background: "linear-gradient(180deg, #EB9220 0%, #002A30 100%)" }} />
                    {/* Photo */}
