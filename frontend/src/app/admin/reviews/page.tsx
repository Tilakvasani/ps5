          ...
          <div key={r.id} className="card">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex gap-1 flex-shrink-0">
                {!r.isApproved && (
                  <button onClick={() => approve(r.id)} className="h-8 w-8 flex items-center justify-center rounded-lg text-emerald-400/60 hover:text-emerald-400 hover:bg-emerald-400/10 transition-all"><CheckCircle size={14} /></button>
                )}
