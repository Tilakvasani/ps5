  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-3xl font-black text-[#002A30]">Reviews</h1>
      </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <span className="font-bold text-[#002A30] text-sm">{r.user?.name}</span>
                ...
                <p className="text-sm text-[#002A30] font-medium">{r.title}</p>
