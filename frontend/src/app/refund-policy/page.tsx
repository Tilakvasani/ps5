  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        {[
          { title: "Return Eligibility", body: "Returns are accepted within 7 days of delivery for products that are damaged, defective, or incorrectly shipped. Products must be unused, in their original packaging, and accompanied by the original invoice." },
          { title: "Non-Returnable Items", body: "Custom-cut or custom-printed packaging materials, opened or partially used rolls, and clearance/sale items are not eligible for return unless they are defective." },
