  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Refund Process", body: "Once your return is received and inspected, we will notify you. Approved refunds are processed within 9-10 business days. Online payments are refunded to the original payment method. COD orders are refunded via bank transfer." },
